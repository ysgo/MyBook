...
<body>
	<div class="wrapper">
		<div style="z-index:500">
	        <a href="${pageContext.request.contextPath}/interestBook" class="brand-logo-main" >
				<div class="container">
        ...
        <div id="content">
			...
			<c:if test="${ !empty list }">	
				...
				<div class="mb-4">지금 사러 가기</div>
				<div class="booklink" style="border: 1px solid lightgray"> 
					<% String encodeStr = (String)request.getAttribute("bookTitle"); %>
					<a href="http://www.kyobobook.co.kr/search/SearchKorbookMain.jsp?vPstrCategory=KOR&vPstrKeyWord=<%= URLEncoder.encode(encodeStr, "euc-kr") %>&vPplace=top" target="_blank">교보문고</a>
					| 
					<a href="http://bsearch.interpark.com/dsearch/book.jsp?sch=all&bid1=search_auto&bid2=product&bid3=000&bid4=001&query=<%= URLEncoder.encode(encodeStr, "euc-kr") %>" target="_blank">인터파크 도서</a>
					| 
					<a href="https://www.aladin.co.kr/search/wsearchresult.aspx?SearchTarget=All&SearchWord=<%= URLEncoder.encode(encodeStr, "euc-kr") %>&x=0&y=0" target="_blank">알라딘</a>
					| 
					<a href="http://www.yes24.com/searchcorner/Search?keywordAd=&keyword=&domain=ALL&qdomain=%C0%FC%C3%BC&Wcode=001_005&query=<%= URLEncoder.encode(encodeStr, "euc-kr") %>" target="_blank">예스24</a>
				</div>		 
				</c:forEach>		
			</c:if>
			<!-- 선택한 관심책 상세 내용 출력 끝 -->
