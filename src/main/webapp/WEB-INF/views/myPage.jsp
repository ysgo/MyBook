	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<article id="updateArticle" class="card-body mx-auto">
				...
				<form action="${pageContext.request.contextPath}/myPage"
					...
					<div class="form-group input-group">
						...
						<input id="rePass" class="form-control" placeholder="비밀번호 확인"
							type="password" required> <input type="button"
							id="checkPass" value="중복확인">
					</div>
				...
				<!-- 탈퇴 페이지 이동 -->
				<div class="form-group">
					<input onclick="location.href='/book/withdrawal'" type="button"
						class="btn btn-primary btn-block" value="탈퇴">
				</div>
