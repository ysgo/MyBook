	...
	<div class="wrapper">
		...
		<div id="content">
							...
							<c:if test="${empty status}">
								<li class="nav-item active">
									<form action="signIn" method="get">
										<input id="signColor" type="submit" value="로그인"
											class="nav-link">
									</form>
								</li>
								<li class="nav-item active">
									<form action="signUp" method="get">
										<input id="signColor" type="submit" value="회원가입"
											class="nav-link">
									</form>
								</li>
							</c:if>
							<c:if test="${!empty status}">
								<li class="nav-item active">
									<form action="signOut" method="post">
										<input id="signColor" type="submit" value="로그아웃"
											class="nav-link" style="color: #58C9B9; font-weight: 700">
									</form>
								</li>
							</c:if>
						</ul>
			...
			<article id="updateArticle" class="card-body mx-auto">
				...
				<!-- 수정 폼태그 시작 -->
				<form action="${pageContext.request.contextPath}/withdrawal"
					method="POST">
					...
					<div class="form-group input-group">
						...
						<input name="checkPass" class="form-control" placeholder="비밀번호 확인"
				...
				<!-- 취소 -->
				<div class="form-group">
					<input onclick="location.href='/book/myPage'" type="button"
						class="btn btn-outline-secondary btn-block" value="취소">
				</div>
