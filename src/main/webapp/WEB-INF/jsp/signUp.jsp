			...
			<form action="${pageContext.request.contextPath}/signUp"
				...
				<div class="form-group input-group">
					...
					<input id="userName" name="userName" class="form-control"
						placeholder="닉네임" type="text" required autofocus>
					<div class="input-group-append">
						<input class="btn btn-primary" type="button" id="name_check"
							value="중복체크">
					</div>
				</div>
				...
				<div class="form-group input-group">
					...
					<div class="input-group-append">
						<input class="btn btn-primary" type="button" id="id_check"
							value="중복체크">
					</div>
				</div>
				...
				<div class="form-group input-group">
					...
					<input class="form-control" id="userPass" name="userPass"
						placeholder="비밀번호" type="password" required> <span
						class="check_font" id="pass_check"></span>
				</div>
				...
				<div class="form-group input-group">
					...
					<div class="input-group-append">
						<input class="btn btn-primary" type="button" id="repass_check"
							value="확인">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<button id="signUp" class="btn btn-outline-secondary btn-block"
						style="font-weight: 700">등록</button>
				</div>
